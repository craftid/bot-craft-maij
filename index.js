...
//
const BotName = 'CRAFT BOT🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/bagusnawal9'; // Nama Instagramlu cok
const whatsapplu = 'tidak ada'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung Saya v:'; // Kapan bot lu aktif
